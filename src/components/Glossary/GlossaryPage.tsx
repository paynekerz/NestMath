...
function AmortizationChart() {
  return (
    <ChartCard
      caption="$300,000 mortgage at 6.75% — how each year's total payments break down"
      legend={[
...
const TERMS: TermData[] = [
  ...
  },
  {
    ...
    extra: 'The chart shows $5,000 invested at three different return rates. Notice how the gap between the lines grows dramatically over time — that\'s the power of compounding.',
    tools: [
      { label: 'HYSA Calculator', href: '/hysa-calculator' },
  ...
  },
  {
    ...
    extra: 'The chart shows two investors — same starting amount, same monthly contributions, same gross return. The only difference is the expense ratio.',
    tools: [
      { label: 'Investment Fees', href: '/investment-fees' },
    ],
  },
  ...
  },
  {
    id: 'inflation',
    term: 'Inflation',
    definition: 'Inflation is the gradual rise in prices over time — which means the same dollar buys less and less as years pass. The US average is about 2–3% per year. If your savings account earns 0.5% while inflation runs at 2.5%, your money is actually losing purchasing power every year, even though the account balance is going up.',
      ...
      <div className="max-w-[800px] mx-auto px-[24px] py-[64px]">
        ...
        <div className="animate-reveal mb-[48px]">
          ...
          <p className="text-body-lg text-on-surface-variant leading-relaxed">
            No jargon. No finance degree needed. {TERMS.length} terms, written so anyone can understand them — with interactive charts where a picture explains it better than words.
          </p>
        </div>
